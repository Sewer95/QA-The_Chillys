...
//    app.getContactHelper().clickADDLink();
//    //app.getContactHelper().fillAddContactForm(new RadioStation().setId(RadioStationData.ID).set(RadioStationData.LAST_NAME).setPhone(RadioStationData.PHONE).setEmail(RadioStationData.EMAIL).setAddress(RadioStationData.ADDRESS).setDescription(RadioStationData.DESC));
//    app.getContactHelper().clickOnSAVEContactButton();
